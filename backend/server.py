...
# Include router
        ...
        {"region_id": "loire", "name": "Loire Valley", "name_pt": "Vale do Loire", "name_en": "Loire Valley", "country_id": "france",
         ...
         "climate": "Oceanic to continental", "key_grapes": ["Sauvignon Blanc", "Chenin Blanc", "Cabernet Franc", "Muscadet"]},
        {"region_id": "alsace", "name": "Alsace", "name_pt": "Alsácia", "name_en": "Alsace", "country_id": "france",
         ...
         "climate": "Cool continental", "key_grapes": ["Riesling", "Gewürztraminer", "Pinot Gris", "Muscat"]},
        {"region_id": "languedoc", "name": "Languedoc-Roussillon", "name_pt": "Languedoc-Roussillon", "name_en": "Languedoc-Roussillon", "country_id": "france",
         ...
         "climate": "Mediterranean", "key_grapes": ["Grenache", "Syrah", "Mourvèdre", "Carignan", "Cinsault", "Picpoul"]},
        {"region_id": "provence", "name": "Provence", "name_pt": "Provença", "name_en": "Provence", "country_id": "france",
         ...
         "climate": "Mediterranean", "key_grapes": ["Grenache", "Cinsault", "Syrah", "Mourvèdre"]},
        {"region_id": "beaujolais", "name": "Beaujolais", "name_pt": "Beaujolais", "name_en": "Beaujolais", "country_id": "france",
         ...
         "climate": "Continental", "key_grapes": ["Gamay"]},
        {"region_id": "cahors", "name": "Cahors", "name_pt": "Cahors", "name_en": "Cahors", "country_id": "france",
         "description_pt": "Berço do Malbec, produzindo vinhos escuros e intensos conhecidos historicamente como 'vinho negro'. Renascimento recente.",
         "description_en": "Birthplace of Malbec, producing dark, intense wines historically known as 'black wine'. Recent renaissance.",
         "climate": "Continental", "key_grapes": ["Malbec"]},
        {"region_id": "bandol", "name": "Bandol", "name_pt": "Bandol", "name_en": "Bandol", "country_id": "france",
         "description_pt": "Pequena denominação na Provença conhecida por seus tintos potentes baseados em Mourvèdre. Vinhos de guarda excepcionais.",
         "description_en": "Small Provence appellation known for powerful Mourvèdre-based reds. Exceptional aging wines.",
         "climate": "Mediterranean", "key_grapes": ["Mourvèdre", "Grenache", "Cinsault"]},
        ...
        {"region_id": "tuscany", "name": "Tuscany", "name_pt": "Toscana", "name_en": "Tuscany", "country_id": "italy",
         ...
         "climate": "Mediterranean", "key_grapes": ["Sangiovese", "Cabernet Sauvignon", "Merlot"]},
        {"region_id": "piedmont", "name": "Piedmont", "name_pt": "Piemonte", "name_en": "Piedmont", "country_id": "italy",
         "description_pt": "Noroeste da Itália, produzindo os majestosos Barolo e Barbaresco de Nebbiolo. Também lar de Barbera e Dolcetto.",
         "description_en": "Northwestern Italy, producing majestic Barolo and Barbaresco from Nebbiolo. Also home to Barbera and Dolcetto.",
         "climate": "Continental", "key_grapes": ["Nebbiolo", "Barbera", "Dolcetto", "Moscato", "Arneis", "Cortese"]},
        {"region_id": "veneto", "name": "Veneto", "name_pt": "Vêneto", "name_en": "Veneto", "country_id": "italy",
         ...
         "climate": "Varied", "key_grapes": ["Corvina", "Rondinella", "Glera", "Garganega"]},
        {"region_id": "sicily", "name": "Sicily", "name_pt": "Sicília", "name_en": "Sicily", "country_id": "italy",
         "description_pt": "Maior ilha do Mediterrâneo, com vinhos do Etna vulcânico aos tintos do interior. Renascimento qualitativo recente.",
         "description_en": "Largest Mediterranean island, from volcanic Etna wines to interior reds. Recent quality renaissance.",
         "climate": "Mediterranean", "key_grapes": ["Nero d'Avola", "Nerello Mascalese", "Grillo", "Carricante"]},
        {"region_id": "campania", "name": "Campania", "name_pt": "Campânia", "name_en": "Campania", "country_id": "italy",
         ...
         "climate": "Mediterranean", "key_grapes": ["Aglianico", "Fiano", "Greco"]},
        {"region_id": "puglia", "name": "Puglia", "name_pt": "Puglia", "name_en": "Puglia", "country_id": "italy",
         "description_pt": "O calcanhar da bota italiana, maior produtor de volume. Primitivo (Zinfandel) e vinhos generosos do sul.",
         "description_en": "The heel of Italy's boot, largest volume producer. Primitivo (Zinfandel) and generous southern wines.",
         "climate": "Mediterranean hot", "key_grapes": ["Primitivo", "Negroamaro", "Nero di Troia"]},
        {"region_id": "abruzzo", "name": "Abruzzo", "name_pt": "Abruzzo", "name_en": "Abruzzo", "country_id": "italy",
         ...
         "climate": "Mediterranean", "key_grapes": ["Montepulciano", "Trebbiano"]},
        {"region_id": "marche", "name": "Marche", "name_pt": "Marche", "name_en": "Marche", "country_id": "italy",
         ...
         "climate": "Mediterranean", "key_grapes": ["Verdicchio", "Montepulciano"]},
        {"region_id": "umbria", "name": "Umbria", "name_pt": "Úmbria", "name_en": "Umbria", "country_id": "italy",
         ...
         "climate": "Continental", "key_grapes": ["Sagrantino", "Sangiovese", "Grechetto"]},
        {"region_id": "friuli", "name": "Friuli-Venezia Giulia", "name_pt": "Friuli-Venezia Giulia", "name_en": "Friuli-Venezia Giulia", "country_id": "italy",
         "description_pt": "Nordeste da Itália, produzindo alguns dos melhores brancos italianos. Pioneiro dos vinhos laranjas modernos.",
         "description_en": "Northeastern Italy, producing some of Italy's best whites. Pioneer of modern orange wines.",
         "climate": "Cool continental", "key_grapes": ["Pinot Grigio", "Friulano", "Ribolla Gialla", "Sauvignon Blanc"]},
        {"region_id": "sardinia", "name": "Sardinia", "name_pt": "Sardenha", "name_en": "Sardinia", "country_id": "italy",
         ...
         "climate": "Mediterranean", "key_grapes": ["Cannonau", "Vermentino", "Carignano"]},
        {"region_id": "lombardy", "name": "Lombardy", "name_pt": "Lombardia", "name_en": "Lombardy", "country_id": "italy",
         ...
         "climate": "Continental", "key_grapes": ["Chardonnay", "Pinot Nero", "Nebbiolo"]},
        
        # SPAIN
        {"region_id": "rioja", "name": "Rioja", "name_pt": "Rioja", "name_en": "Rioja", "country_id": "spain",
         "description_pt": "A região mais prestigiosa da Espanha, conhecida por Tempranillo envelhecido em carvalho. Sistema de classificação por tempo de envelhecimento.",
         "description_en": "Spain's most prestigious region, known for oak-aged Tempranillo. Classification system by aging time.",
         "climate": "Continental", "key_grapes": ["Tempranillo", "Garnacha", "Graciano", "Viura"]},
        {"region_id": "ribera_del_duero", "name": "Ribera del Duero", "name_pt": "Ribera del Duero", "name_en": "Ribera del Duero", "country_id": "spain",
         ...
         "climate": "Continental extreme", "key_grapes": ["Tempranillo", "Cabernet Sauvignon"]},
        {"region_id": "priorat", "name": "Priorat", "name_pt": "Priorat", "name_en": "Priorat", "country_id": "spain",
         "description_pt": "Catalunha, renascida nos anos 1980. Solos de licorella (xisto) e vinhos potentes de Garnacha e Cariñena.",
         "description_en": "Catalonia, reborn in the 1980s. Licorella (schist) soils and powerful Garnacha and Cariñena wines.",
         "climate": "Mediterranean hot", "key_grapes": ["Garnacha", "Cariñena", "Cabernet Sauvignon"]},
        {"region_id": "rias_baixas", "name": "Rías Baixas", "name_pt": "Rías Baixas", "name_en": "Rías Baixas", "country_id": "spain",
         "description_pt": "Galícia atlântica, produzindo brancos aromáticos de Albariño. Clima fresco e úmido.",
         "description_en": "Atlantic Galicia, producing aromatic Albariño whites. Cool, humid climate.",
         "climate": "Atlantic", "key_grapes": ["Albariño"]},
        {"region_id": "rueda", "name": "Rueda", "name_pt": "Rueda", "name_en": "Rueda", "country_id": "spain",
         "description_pt": "Castilla y León, especializada em Verdejo aromático e refrescante. Renascimento nos anos 1980.",
         "description_en": "Castilla y León, specializing in aromatic, refreshing Verdejo. 1980s renaissance.",
         "climate": "Continental", "key_grapes": ["Verdejo", "Sauvignon Blanc"]},
        {"region_id": "penedes", "name": "Penedès", "name_pt": "Penedès", "name_en": "Penedès", "country_id": "spain",
         "description_pt": "Catalunha, coração da produção de Cava. Também produz brancos e tintos tranquilos de qualidade.",
         "description_en": "Catalonia, heart of Cava production. Also produces quality still whites and reds.",
         "climate": "Mediterranean", "key_grapes": ["Macabeo", "Xarel·lo", "Parellada", "Garnacha"]},
        {"region_id": "jerez", "name": "Jerez", "name_pt": "Jerez", "name_en": "Jerez (Sherry)", "country_id": "spain",
         "description_pt": "Andaluzia, única região para Sherry autêntico. Sistema de solera e vinhos únicos como Fino, Oloroso e PX.",
         "description_en": "Andalusia, only region for authentic Sherry. Solera system and unique wines like Fino, Oloroso and PX.",
         "climate": "Mediterranean hot", "key_grapes": ["Palomino Fino", "Pedro Ximénez", "Moscatel"]},
        {"region_id": "bierzo", "name": "Bierzo", "name_pt": "Bierzo", "name_en": "Bierzo", "country_id": "spain",
         "description_pt": "Noroeste da Espanha, produzindo Mencía elegante comparada a Pinot Noir. Região em ascensão.",
         "description_en": "Northwestern Spain, producing elegant Mencía compared to Pinot Noir. Rising region.",
         "climate": "Atlantic-Continental", "key_grapes": ["Mencía", "Godello"]},
        {"region_id": "navarra", "name": "Navarra", "name_pt": "Navarra", "name_en": "Navarra", "country_id": "spain",
         "description_pt": "Vizinha de Rioja, conhecida por rosés e vinhos tintos de valor. Experimentação com variedades internacionais.",
         "description_en": "Rioja's neighbor, known for rosés and value reds. Experimentation with international varieties.",
         "climate": "Continental", "key_grapes": ["Garnacha", "Tempranillo", "Cabernet Sauvignon"]},
        {"region_id": "jumilla", "name": "Jumilla", "name_pt": "Jumilla", "name_en": "Jumilla", "country_id": "spain",
         "description_pt": "Murcia, especializada em Monastrell (Mourvèdre) potente. Vinhas velhas e vinhos concentrados.",
         "description_en": "Murcia, specializing in powerful Monastrell (Mourvèdre). Old vines and concentrated wines.",
         "climate": "Continental-Mediterranean", "key_grapes": ["Monastrell", "Garnacha"]},
        {"region_id": "toro", "name": "Toro", "name_pt": "Toro", "name_en": "Toro", "country_id": "spain",
         "description_pt": "Castilla y León, produzindo Tempranillo extremamente potente (Tinta de Toro). Vinhos concentrados e tânicos.",
         "description_en": "Castilla y León, producing extremely powerful Tempranillo (Tinta de Toro). Concentrated, tannic wines.",
         "climate": "Continental extreme", "key_grapes": ["Tempranillo"]},
        {"region_id": "valdeorras", "name": "Valdeorras", "name_pt": "Valdeorras", "name_en": "Valdeorras", "country_id": "spain",
         "description_pt": "Galícia interior, produzindo brancos de Godello de alta qualidade. Solos de ardósia.",
         "description_en": "Interior Galicia, producing high-quality Godello whites. Slate soils.",
         "climate": "Atlantic-Continental", "key_grapes": ["Godello", "Mencía"]},
        
        # PORTUGAL
        {"region_id": "douro", "name": "Douro", "name_pt": "Douro", "name_en": "Douro", "country_id": "portugal",
         "description_pt": "Património Mundial da UNESCO, produzindo Porto e vinhos tintos de classe mundial. Terraços espetaculares.",
         "description_en": "UNESCO World Heritage, producing Port and world-class red wines. Spectacular terraces.",
         "climate": "Continental Mediterranean", "key_grapes": ["Touriga Nacional", "Touriga Franca", "Tinta Roriz", "Tinta Cão"]},
        {"region_id": "dao", "name": "Dão", "name_pt": "Dão", "name_en": "Dão", "country_id": "portugal",
         "description_pt": "Centro de Portugal, produzindo tintos elegantes e brancos de Encruzado. Altitude e granito.",
         "description_en": "Central Portugal, producing elegant reds and Encruzado whites. Altitude and granite.",
         "climate": "Continental", "key_grapes": ["Touriga Nacional", "Jaen", "Encruzado"]},
        {"region_id": "vinho_verde", "name": "Vinho Verde", "name_pt": "Vinho Verde", "name_en": "Vinho Verde", "country_id": "portugal",
         "description_pt": "Noroeste de Portugal, produzindo brancos leves e frescos. Alvarinho premium de Monção e Melgaço.",
         "description_en": "Northwestern Portugal, producing light, fresh whites. Premium Alvarinho from Monção and Melgaço.",
         "climate": "Atlantic", "key_grapes": ["Alvarinho", "Loureiro", "Arinto"]},
        {"region_id": "alentejo", "name": "Alentejo", "name_pt": "Alentejo", "name_en": "Alentejo", "country_id": "portugal",
         ...
         "climate": "Mediterranean hot", "key_grapes": ["Aragonez", "Trincadeira", "Alicante Bouschet", "Antão Vaz"]},
        {"region_id": "bairrada", "name": "Bairrada", "name_pt": "Bairrada", "name_en": "Bairrada", "country_id": "portugal",
         "description_pt": "Litoral centro, conhecida pela uva Baga tânica. Também produz excelentes espumantes.",
         "description_en": "Central coast, known for tannic Baga grape. Also produces excellent sparkling wines.",
         "climate": "Atlantic", "key_grapes": ["Baga", "Maria Gomes"]},
        {"region_id": "setubal", "name": "Península de Setúbal", "name_pt": "Península de Setúbal", "name_en": "Setúbal Peninsula", "country_id": "portugal",
         "description_pt": "Sul de Lisboa, famosa pelo Moscatel de Setúbal fortificado e vinhos tintos de Castelão.",
         "description_en": "South of Lisbon, famous for fortified Moscatel de Setúbal and Castelão reds.",
         "climate": "Mediterranean", "key_grapes": ["Castelão", "Moscatel"]},
        
        # GERMANY
        {"region_id": "mosel", "name": "Mosel", "name_pt": "Mosel", "name_en": "Mosel", "country_id": "germany",
         "description_pt": "Vale do rio Mosel, produzindo os Rieslings mais elegantes e minerais do mundo. Vinhedos em encostas íngremes.",
         "description_en": "Mosel river valley, producing the world's most elegant, mineral Rieslings. Steep slope vineyards.",
         "climate": "Cool continental", "key_grapes": ["Riesling"]},
        {"region_id": "rheingau", "name": "Rheingau", "name_pt": "Rheingau", "name_en": "Rheingau", "country_id": "germany",
         "description_pt": "Berço do Riesling seco alemão. Orientação sul ideal e solos de ardósia.",
         "description_en": "Birthplace of dry German Riesling. Ideal south-facing orientation and slate soils.",
         "climate": "Cool continental", "key_grapes": ["Riesling", "Spätburgunder"]},
        {"region_id": "pfalz", "name": "Pfalz", "name_pt": "Pfalz", "name_en": "Pfalz", "country_id": "germany",
         "description_pt": "Segunda maior região da Alemanha, clima mais quente. Riesling e Pinot Noir de qualidade.",
         "description_en": "Germany's second largest region, warmer climate. Quality Riesling and Pinot Noir.",
         "climate": "Cool continental", "key_grapes": ["Riesling", "Spätburgunder", "Dornfelder"]},
        {"region_id": "baden", "name": "Baden", "name_pt": "Baden", "name_en": "Baden", "country_id": "germany",
         "description_pt": "Região mais quente e ensolarada da Alemanha. Especializada em Pinot Noir (Spätburgunder).",
         "description_en": "Germany's warmest, sunniest region. Specializing in Pinot Noir (Spätburgunder).",
         "climate": "Warm continental", "key_grapes": ["Spätburgunder", "Grauburgunder", "Weissburgunder"]},
        {"region_id": "franken", "name": "Franken", "name_pt": "Francônia", "name_en": "Franken", "country_id": "germany",
         ...
         "climate": "Continental", "key_grapes": ["Silvaner", "Müller-Thurgau", "Riesling"]},
        {"region_id": "ahr", "name": "Ahr", "name_pt": "Ahr", "name_en": "Ahr", "country_id": "germany",
         "description_pt": "Pequena região ao norte, surpreendentemente especializada em Pinot Noir de alta qualidade.",
         "description_en": "Small northern region, surprisingly specializing in high-quality Pinot Noir.",
         "climate": "Cool continental", "key_grapes": ["Spätburgunder"]},
        {"region_id": "rheinhessen", "name": "Rheinhessen", "name_pt": "Rheinhessen", "name_en": "Rheinhessen", "country_id": "germany",
         "description_pt": "Maior região vinícola da Alemanha. Grande variedade de estilos, do comercial ao premium.",
         "description_en": "Germany's largest wine region. Wide variety of styles, from commercial to premium.",
         "climate": "Continental", "key_grapes": ["Riesling", "Müller-Thurgau", "Silvaner", "Dornfelder"]},
        ...
        {"region_id": "wachau", "name": "Wachau", "name_pt": "Wachau", "name_en": "Wachau", "country_id": "austria",
         ...
         "climate": "Cool continental", "key_grapes": ["Grüner Veltliner", "Riesling"]},
        {"region_id": "kamptal", "name": "Kamptal", "name_pt": "Kamptal", "name_en": "Kamptal", "country_id": "austria",
         "description_pt": "Norte da Áustria, produzindo Grüner Veltliner expressivo com notas de pimenta branca.",
         "description_en": "Northern Austria, producing expressive Grüner Veltliner with white pepper notes.",
         "climate": "Cool continental", "key_grapes": ["Grüner Veltliner", "Riesling"]},
        {"region_id": "kremstal", "name": "Kremstal", "name_pt": "Kremstal", "name_en": "Kremstal", "country_id": "austria",
         "description_pt": "Entre Wachau e Kamptal, combinando elementos de ambos. Excelentes brancos secos.",
         "description_en": "Between Wachau and Kamptal, combining elements of both. Excellent dry whites.",
         "climate": "Cool continental", "key_grapes": ["Grüner Veltliner", "Riesling"]},
        ...
        {"region_id": "napa_valley", "name": "Napa Valley", "name_pt": "Vale de Napa", "name_en": "Napa Valley", "country_id": "usa",
         ...
         "climate": "Mediterranean", "key_grapes": ["Cabernet Sauvignon", "Merlot", "Chardonnay"]},
        {"region_id": "sonoma", "name": "Sonoma", "name_pt": "Sonoma", "name_en": "Sonoma", "country_id": "usa",
         ...
         "climate": "Varied", "key_grapes": ["Pinot Noir", "Chardonnay", "Zinfandel"]},
        {"region_id": "oregon", "name": "Oregon", "name_pt": "Oregon", "name_en": "Oregon", "country_id": "usa",
         "description_pt": "Noroeste dos EUA, clima frio ideal para Pinot Noir. Willamette Valley é a região principal.",
         "description_en": "Pacific Northwest, cool climate ideal for Pinot Noir. Willamette Valley is the main region.",
         "climate": "Cool maritime", "key_grapes": ["Pinot Noir", "Pinot Gris", "Chardonnay"]},
        {"region_id": "washington", "name": "Washington State", "name_pt": "Estado de Washington", "name_en": "Washington State", "country_id": "usa",
         "description_pt": "Segundo maior produtor dos EUA. Columbia Valley produz excelentes Cabernet, Merlot e Syrah.",
         "description_en": "Second largest US producer. Columbia Valley produces excellent Cabernet, Merlot and Syrah.",
         "climate": "Continental desert", "key_grapes": ["Cabernet Sauvignon", "Merlot", "Syrah", "Riesling"]},
        {"region_id": "finger_lakes", "name": "Finger Lakes", "name_pt": "Finger Lakes", "name_en": "Finger Lakes", "country_id": "usa",
         "description_pt": "Nova York, especializada em Riesling de clima frio. Lagos glaciais moderam o clima.",
         "description_en": "New York, specializing in cool-climate Riesling. Glacial lakes moderate the climate.",
         "climate": "Cool continental", "key_grapes": ["Riesling", "Cabernet Franc", "Gewürztraminer"]},
        
        # ARGENTINA
        {"region_id": "mendoza", "name": "Mendoza", "name_pt": "Mendoza", "name_en": "Mendoza", "country_id": "argentina",
         "description_pt": "Coração vinícola da Argentina, produzindo 70% dos vinhos do país. Malbec de altitude é a especialidade.",
         "description_en": "Argentina's wine heartland, producing 70% of the country's wines. Altitude Malbec is the specialty.",
         "climate": "Continental desert", "key_grapes": ["Malbec", "Cabernet Sauvignon", "Bonarda"]},
        {"region_id": "salta", "name": "Salta", "name_pt": "Salta", "name_en": "Salta", "country_id": "argentina",
         ...
         "climate": "High altitude desert", "key_grapes": ["Torrontés", "Malbec"]},
        {"region_id": "la_rioja_arg", "name": "La Rioja (Argentina)", "name_pt": "La Rioja (Argentina)", "name_en": "La Rioja (Argentina)", "country_id": "argentina",
         "description_pt": "Uma das regiões mais antigas da Argentina, conhecida por Torrontés branco aromático.",
         "description_en": "One of Argentina's oldest regions, known for aromatic white Torrontés.",
         "climate": "Continental desert", "key_grapes": ["Torrontés", "Bonarda"]},
        ...
        {"region_id": "maipo", "name": "Maipo Valley", "name_pt": "Vale do Maipo", "name_en": "Maipo Valley", "country_id": "chile",
         ...
         "climate": "Mediterranean", "key_grapes": ["Cabernet Sauvignon", "Carménère", "Merlot"]},
        {"region_id": "colchagua", "name": "Colchagua Valley", "name_pt": "Vale de Colchagua", "name_en": "Colchagua Valley", "country_id": "chile",
         ...
         "climate": "Mediterranean", "key_grapes": ["Carménère", "Cabernet Sauvignon", "Syrah"]},
        {"region_id": "casablanca", "name": "Casablanca Valley", "name_pt": "Vale de Casablanca", "name_en": "Casablanca Valley", "country_id": "chile",
         "description_pt": "Região costeira fria, ideal para brancos e Pinot Noir. Influência do Oceano Pacífico.",
         "description_en": "Cool coastal region, ideal for whites and Pinot Noir. Pacific Ocean influence.",
         "climate": "Cool maritime", "key_grapes": ["Sauvignon Blanc", "Chardonnay", "Pinot Noir"]},
        {"region_id": "leyda", "name": "Leyda Valley", "name_pt": "Vale de Leyda", "name_en": "Leyda Valley", "country_id": "chile",
         ...
         "climate": "Cool maritime", "key_grapes": ["Sauvignon Blanc", "Pinot Noir", "Chardonnay"]},
        {"region_id": "cachapoal", "name": "Cachapoal Valley", "name_pt": "Vale de Cachapoal", "name_en": "Cachapoal Valley", "country_id": "chile",
         ...
         "climate": "Mediterranean", "key_grapes": ["Carménère", "Cabernet Sauvignon", "Merlot"]},
        ...
        {"region_id": "barossa_valley", "name": "Barossa Valley", "name_pt": "Vale de Barossa", "name_en": "Barossa Valley", "country_id": "australia",
         ...
         "climate": "Mediterranean warm", "key_grapes": ["Shiraz", "Grenache", "Mataro"]},
        {"region_id": "mclaren_vale", "name": "McLaren Vale", "name_pt": "McLaren Vale", "name_en": "McLaren Vale", "country_id": "australia",
         "description_pt": "Sul da Austrália, produzindo Shiraz e Grenache de alta qualidade com influência marítima.",
         "description_en": "South Australia, producing high-quality Shiraz and Grenache with maritime influence.",
         "climate": "Mediterranean", "key_grapes": ["Shiraz", "Grenache", "Cabernet Sauvignon"]},
        {"region_id": "coonawarra", "name": "Coonawarra", "name_pt": "Coonawarra", "name_en": "Coonawarra", "country_id": "australia",
         ...
         "climate": "Cool maritime", "key_grapes": ["Cabernet Sauvignon", "Shiraz"]},
        {"region_id": "hunter_valley", "name": "Hunter Valley", "name_pt": "Hunter Valley", "name_en": "Hunter Valley", "country_id": "australia",
         "description_pt": "Nova Gales do Sul, produzindo Sémillon único que envelhece magnificamente e Shiraz terroso.",
         "description_en": "New South Wales, producing unique Sémillon that ages magnificently and earthy Shiraz.",
         "climate": "Humid subtropical", "key_grapes": ["Sémillon", "Shiraz", "Chardonnay"]},
        {"region_id": "clare_valley", "name": "Clare Valley", "name_pt": "Clare Valley", "name_en": "Clare Valley", "country_id": "australia",
         ...
         "climate": "Continental", "key_grapes": ["Riesling", "Shiraz", "Cabernet Sauvignon"]},
        {"region_id": "margaret_river", "name": "Margaret River", "name_pt": "Margaret River", "name_en": "Margaret River", "country_id": "australia",
         "description_pt": "Oeste da Austrália, produzindo blends bordaleses elegantes e Chardonnay de classe mundial.",
         "description_en": "Western Australia, producing elegant Bordeaux blends and world-class Chardonnay.",
         "climate": "Maritime Mediterranean", "key_grapes": ["Cabernet Sauvignon", "Chardonnay", "Sauvignon Blanc", "Sémillon"]},
        {"region_id": "yarra_valley", "name": "Yarra Valley", "name_pt": "Yarra Valley", "name_en": "Yarra Valley", "country_id": "australia",
         ...
         "climate": "Cool maritime", "key_grapes": ["Pinot Noir", "Chardonnay", "Shiraz"]},
        ...
        {"region_id": "central_otago", "name": "Central Otago", "name_pt": "Central Otago", "name_en": "Central Otago", "country_id": "new_zealand",
         ...
         "climate": "Continental", "key_grapes": ["Pinot Noir", "Riesling", "Pinot Gris"]},
        {"region_id": "martinborough", "name": "Martinborough", "name_pt": "Martinborough", "name_en": "Martinborough", "country_id": "new_zealand",
         ...
         "climate": "Cool maritime", "key_grapes": ["Pinot Noir", "Sauvignon Blanc"]},
        
        # SOUTH AFRICA
        {"region_id": "stellenbosch", "name": "Stellenbosch", "name_pt": "Stellenbosch", "name_en": "Stellenbosch", "country_id": "south_africa",
         "description_pt": "A região mais prestigiosa da África do Sul, produzindo excelentes tintos e blends bordaleses.",
         "description_en": "South Africa's most prestigious region, producing excellent reds and Bordeaux blends.",
         "climate": "Mediterranean", "key_grapes": ["Cabernet Sauvignon", "Pinotage", "Shiraz", "Chenin Blanc"]},
        {"region_id": "swartland", "name": "Swartland", "name_pt": "Swartland", "name_en": "Swartland", "country_id": "south_africa",
         "description_pt": "Região renascentista produzindo vinhos naturais e de vinhas velhas. Foco em Chenin Blanc e blends do Rhône.",
         "description_en": "Renaissance region producing natural and old-vine wines. Focus on Chenin Blanc and Rhône blends.",
         "climate": "Mediterranean", "key_grapes": ["Chenin Blanc", "Syrah", "Grenache", "Mourvèdre"]},
        {"region_id": "constantia", "name": "Constantia", "name_pt": "Constantia", "name_en": "Constantia", "country_id": "south_africa",
         "description_pt": "Região histórica perto da Cidade do Cabo, famosa no século 18 por vinhos doces. Hoje produz excelentes brancos.",
         "description_en": "Historic region near Cape Town, famous in the 18th century for sweet wines. Today produces excellent whites.",
         "climate": "Cool maritime", "key_grapes": ["Sauvignon Blanc", "Sémillon"]},
        ...
        {"region_id": "canelones", "name": "Canelones", "name_pt": "Canelones", "name_en": "Canelones", "country_id": "uruguay",
         ...
         "climate": "Maritime", "key_grapes": ["Tannat", "Merlot", "Cabernet Sauvignon"]},
    ]
    ...
    return {
        "message": "Complete regions database seeded successfully",
        "regions_added": len(regions_data),
        "countries_covered": len(set(r["country_id"] for r in regions_data))
    }
