    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <Button
            ...
            type="button"
            variant="outline"
            className="w-full py-6 mb-6 rounded-sm border-border"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 py-6 rounded-sm"
                  required
                />
                <button
                  type="button"
            ...
            <Button
              ...
              type="submit"
              className="w-full py-6 bg-wine-500 hover:bg-wine-600 text-white rounded-sm font-serif tracking-wide"
              disabled={loading}
            >
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <div 
          ...
          style={{ 
            backgroundImage: 'url(https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?crop=entropy&cs=srgb&fm=jpg&q=85)',
          }}
        >
          <div className="absolute inset-0 bg-wine-900/60" />
        </div>
